...
describe 'Subscribe', :js, type: :feature do
  ...
  context 'for a subscribed team' do
    ...
    it 'displays an error' do
      expect(find_by_id('messages')).to have_text("Team #{team.team_name} is already subscribed, thank you for your support.")
      find_by_id('subscribe', visible: false)
    end
  end
  ...
  context 'stripe' do
    ...
    context 'for a team with an expired subscription' do
      ...
      it 'subscribes team' do
        ...
        find_by_id('subscribe', visible: false)
        expect(find_by_id('messages')).to have_text("Team #{team.team_name} successfully subscribed.\n\nThank you for your support!")
