  ...
  context 'with a stripe key' do
    ...
    context 'a team with a stripe customer ID' do
      ...
      it 'updates cc' do
        ...
        expect(find('h1')).to have_text('Strata: Update Credit Card Info')
        expect(find_by_id('messages')).to have_text("Click button to update the credit card for team #{team.team_name}.")
        customer = double
        ...
        expect(find_by_id('messages')).to have_text("Successfully updated team #{team.team_name} credit card.\n\nThank you for your support!")
      end
    end
