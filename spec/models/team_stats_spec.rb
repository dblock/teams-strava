  ...
  context 'with no activities' do
    ...
    describe '#to_message' do
      it 'defaults to no activities' do
        expect(stats.to_message).to eq('There are no activities in this channel.')
      end
    end
  end
  ...
  context 'with activities' do
    ...
    describe '#to_message' do
      ...
      it 'includes all activities' do
        expect(stats.to_message[:embeds].count).to eq(3)
      end
      ...
      context 'with a start date' do
        ...
        it 'includes a period label' do
          expect(stats.to_message[:content]).to include('after')
        end
      end
      ...
      context 'with a start and end date' do
        ...
        it 'includes a period label' do
          expect(stats.to_message[:content]).to include('between')
        end
      end
    end
  end
