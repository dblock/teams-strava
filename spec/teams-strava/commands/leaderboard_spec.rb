...
describe TeamsStrava::Commands::Leaderboard do
  ...
  context 'leaderboard with options' do
    include_context 'teams command' do
      let(:args) { %w[leaderboard elapsed_time] }
    end
  ...
  context 'with a default team leaderboard' do
    ...
    context 'with an expression' do
      include_context 'teams command' do
        let(:args) { ['leaderboard', 'two days ago'] }
      end
  ...
  context 'with a month' do
    include_context 'teams command' do
      let(:args) { ['leaderboard', 'September 2023'] }
    end
  ...
  context 'with an ISO date' do
    include_context 'teams command' do
      let(:args) { ['leaderboard', 'moving time 2023-03-01'] }
    end
  ...
  context 'since' do
    include_context 'teams command' do
      let(:args) { ['leaderboard', 'since September 2023'] }
    end
  ...
  context 'between' do
    include_context 'teams command' do
      let(:args) { ['leaderboard', 'between September 2023 and August 2024'] }
    end
