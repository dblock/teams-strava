module TeamsStrava
  class App
    ...
    # Teams commands are declared statically in the app manifest (see
    # manifest/manifest.json), there is nothing to install at runtime.
    ...
    def ensure_strava_webhook!
      return if TeamsStrava::Service.localhost?
    ...
    def deactivate_asleep_teams!
      ...
      Team.active.each do |team|
        ...
        begin
          team.deactivate!
          purge_message = "Your subscription expired more than 2 weeks ago, deactivating. Reactivate at #{TeamsStrava::Service.url}. Your data will be purged in another 2 weeks."
    ...
    def check_stripe_subscribers!
      Stripe::Subscription.list(plan: 'strata-yearly').auto_paging_each do |subscription|
